		...
		<section className={styles.footer}>
			<div className="container mx-auto">
				<div className="flex flex-col xl:flex-row justify-between gap-x-4">
					<div className="w-1/4 flex flex-col text-left justify-between">
					...
					<div className="w-1/4 flex flex-col gap-1 justify-start">
					...
					<div className="w-3/4 flex text-sm flex-col text-right justify-center">
